...
# The admin_site must be an instance of a class that inherits from
# django.contrib.admin.AdminSite
class MyAdminSite(admin.AdminSite):
    site_header = "Vangarde Music Limited"
    site_title = "Vangarde Music Limited"
    index_title = "Welcome to Vangarde Music Limited"
...
@admin.register(Library, site=admin_site)
...
@admin.register(LibraryRelease, site=admin_site)
...
@admin.register(CommercialRelease, site=admin_site)
...
@admin.register(Writer, site=admin_site)
...
@admin.register(Work, site=admin_site)
...
@admin.register(Recording, site=admin_site)
...
@admin.register(CWRExport, site=admin_site)
