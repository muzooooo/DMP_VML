...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-@1%0^u09&_j2o6g9h5q!t8^p$h4!c-^9m9=q+f&y-s#d3a')
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, 'templates')], # MODIFIED LINE: Added path to your project's templates directory
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
